...
public class JSONWorkMain {
	...
	public static void main(String... args) {
		...
		obj = JSON.createNumber(123);
		System.out.print("123:\ttypeof num  = " + obj.typeof());
		System.out.print("\t valueOf num  = " + obj.valueOf());
		System.out.print("\t " + obj.toString());
		System.out.println("\t " + obj.stringify());
		System.out.println(obj.toIniFile());

		obj = JSON.createNumber(1.23);
		System.out.print("1.23:\ttypeof num  = " + obj.typeof());
		System.out.print("\t valueOf num  = " + obj.valueOf());
		System.out.print("\t " + obj.toString());
		System.out.println("\t " + obj.stringify());
		System.out.println(obj.toIniFile());
		...
		try {
			str = "123";
			obj = JSON.createNumber(str);
			System.out.print(str + ":\ttypeof num  = " + obj.typeof());
			System.out.print("\t valueOf num  = " + obj.valueOf());
			System.out.print("\t " + obj.toString());
			System.out.println("\t " + obj.stringify());
			System.out.println(obj.toIniFile());
		...
		obj = JSON.createBoolean(true);
		System.out.print("typeof bool = " + obj.typeof());
		System.out.print("\t valueOf bool = " + obj.valueOf());
		System.out.print("\t " + obj.toString());
		System.out.println("\t " + obj.stringify());
		System.out.println(obj.toIniFile());
		...
		try {
			str = "true";
			obj = JSON.createBoolean(str);
			System.out.print(str + ":\ttypeof bool = " + obj.typeof());
			System.out.print("\t valueOf bool = " + obj.valueOf());
			System.out.print("\t " + obj.toString());
			System.out.println("\t " + obj.stringify());
			System.out.println(obj.toIniFile());
		...
		obj = JSON.createString("str\"quote");
		System.out.print("typeof str  = " + obj.typeof());
		System.out.print("\t valueOf str  = " + obj.valueOf());
		System.out.print("\t " + obj.toString());
		System.out.println("\t " + obj.stringify());
		System.out.println(obj.toIniFile());

		obj = JSON.createNull();
		System.out.print("typeof null = " + obj.typeof());
		System.out.print("\t valueOf null = " + obj.valueOf());
		System.out.print("\t " + obj.toString());
		System.out.println("\t " + obj.stringify());
		System.out.println(obj.toIniFile());
